...
if __name__ == "__main__":
    ...
    for epoch in range(args.num_epochs):
        ...
        checkpoint_path = os.path.join(checkpoint_dir, f'retrained_model_epoch_{epoch + 1}.pth')
    ...
    if best_model_checkpoint is not None:
        best_model_path = os.path.join(checkpoint_dir, f'best_retrained_model_epoch_{best_model_checkpoint.epoch}.pth')
    ...
    output_path = os.path.join(output_dir, "retraining_stats.json")
